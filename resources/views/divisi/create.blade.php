            ...
            <div class="col-lg-12 col-sm-6 col-md-3">
                <div class="card">
                    <div class="card-header">
                      <h3 class="card-title">Input Data Divisi Baru</h3>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
                        <form action="{{ route('divisi.store') }}" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="nama_divisi" class="form-control" @error('nama_divisi') ins-invalid @enderror value="{{ old('nama_divisi')}}" required>
                                @error('nama_divisi')
