...
@section('judul')
    <h1>Form Pembaruan Data Jenis Kegiatan</h1>
@endsection
            ...
            <div class="col-lg-12 col-sm-6 col-md-3">
                <div class="card">
                    <div class="card-header">
                      <h3 class="card-title">Pembaruan Data Jenis Kegiatan </h3>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
                        <form action="{{ route('jeniskegiatan.update', $jeniskegiatan->id) }}" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="nama_jenis_kegiatan" class="form-control" @error('nama_jenis_kegiatan') ins-invalid @enderror value="{{ old('nama_jenis_kegiatan') ?? $jeniskegiatan->nama_jenis_kegiatan}}" required>
                            ...
                            <div class="form-group">
                                ...
                                <textarea id="field" onkeyup="countChar(this)" class="form-control @error('keterangan_jenis_kegiatan') is-invalid @enderror" name="keterangan_jenis_kegiatan"  rows="10" required>
                                    {{  old('keterangan_jenis_kegiatan') ?? $jeniskegiatan->keterangan_jenis_kegiatan }}
                                </textarea>
                            </div>
